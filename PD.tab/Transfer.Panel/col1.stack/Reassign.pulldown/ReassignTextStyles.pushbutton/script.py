...
Switch all notes using selected text styles to a target style.
...
used_styles = [
    name for name, t in type_name_map.items() if t.Id.IntegerValue in used_type_ids
]
...
forms.alert(
    "✅ Reassigned {} text note(s) to style: {}".format(count, target_style_name)
)
