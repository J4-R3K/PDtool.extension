# -*- coding: utf-8 -*-
__title__   = "Copy: Legends from a linked model"
__doc__     = """Version = 1.0
Date    = 20.12.2025
________________________________________________________________
Description:

Copy selected Legends from a linked Revit model into the main opened project.
...
def select_legends(linked_doc):
    ...
    legend_views = [
        v for v in legends if v.ViewType == ViewType.Legend and not v.IsTemplate
    ]
