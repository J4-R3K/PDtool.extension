...
Transfers specific filters and its settings from current model and cloud-based linked models to the main model.
...
def select_views(prompt_title="Select Views"):
    ...
    selected_views = forms.SelectFromList.show(
        sorted(view_names), multiselect=True, title=prompt_title, button_name="Select"
    )
