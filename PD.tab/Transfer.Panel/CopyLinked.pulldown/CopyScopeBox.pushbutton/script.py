# -*- coding: utf-8 -*-
__title__   = "Copy: Scope boxes"
__doc__     = """Version = 1.0
Date    = 20.12.2025
________________________________________________________________
Description:

Copies specific scopeboxes from cloud-based linked models to the main model.
    ...
    with Transaction(doc, "Transfer Selected Scope Boxes") as trans:
        ...
        for scope_box in scope_boxes_to_copy:
            ...
            if existing_scope_box:
                print(
                    "Scope Box '{}' already exists in main document. Skipping...".format(
                        scope_box.Name
                    )
                )
                continue
            ...
            if copied_ids:
                print(
                    "Successfully copied scope box '{}' to main document.".format(
                        scope_box.Name
                    )
                )
            else:
