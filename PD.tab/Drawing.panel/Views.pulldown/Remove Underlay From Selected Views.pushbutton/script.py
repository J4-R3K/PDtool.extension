...
selected_views = forms.select_views(
    filterfunc=lambda x: isinstance(x, DB.ViewPlan), use_selection=True
)
...
if selected_views:
    ...
    with revit.Transaction("Batch Set Underlay to None"):
        for view in selected_views:
            if get_elementid_value(view.Category.Id) == int(
                ...
                if HOST_APP.is_newer_than(2016):
                    ...
                    p = view.get_Parameter(DB.BuiltInParameter.VIEW_UNDERLAY_ID)
