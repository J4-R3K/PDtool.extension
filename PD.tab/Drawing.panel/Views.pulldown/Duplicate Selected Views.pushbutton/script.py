...
selected_views = forms.select_views(filterfunc=duplicableview, use_selection=True)

if selected_views:
    selected_option = forms.CommandSwitchWindow.show(
        ["WITH Detailing", "WITHOUT Detailing", "AS Dependent"],
