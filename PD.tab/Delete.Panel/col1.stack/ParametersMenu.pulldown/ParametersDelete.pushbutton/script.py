# -*- coding: utf-8 -*-
__title__   = "Parameters: Delete project parameters"
__doc__     = """Version = 1.0
Date    = 20.12.2025
________________________________________________________________
Description:

Show and delete project parameters with audit UI.
...
def main():
    ...
    items = [
        "{} [{}] - {}".format(p["name"], p["type"], p["categories"]) for p in param_data
    ]
        ...
        for definition, name in selected_defs:
            try:
                ...
                script.get_output().print_md(
                    "*Could not delete `{}` – {}*".format(name, e)
                )
        t.Commit()
