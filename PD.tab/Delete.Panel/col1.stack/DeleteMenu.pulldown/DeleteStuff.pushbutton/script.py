# -*- coding: utf-8 -*-
__title__   = "Delete: force delete"
__doc__     = """Version = 1.0
Date    = 20.12.2025
________________________________________________________________
Description:

deletes stubborn stuff
...
def delete_selected_element():
    ...
    with DB.Transaction(doc, "Delete Selected Element") as trans:
        try:
            ...
            pickedRef = selection.PickObject(
                ObjectType.Element, "Please select an element to delete"
            )
            ...
            if trans.GetStatus() == DB.TransactionStatus.Started:
                trans.RollBack()
            TaskDialog.Show(
                "Error", "Failed to delete element. Error: {0}".format(str(e))
            )
